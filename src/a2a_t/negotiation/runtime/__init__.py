...
``negotiation.runtime`` package. It is kept unchanged for one release and will be removed in the
next release; importing it emits a :class:`DeprecationWarning`.
"""

import warnings

from .base_negotiation_orchestrator import BaseNegotiationOrchestrator
...
warnings.warn(
    "The a2a_t.negotiation.runtime package is deprecated since 1.1.0 and will be removed in the "
